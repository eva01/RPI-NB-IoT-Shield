...
while 1:
	...
	while 1:
        ...
        data = '{{"_0":{0}, "_1":{1}, "_2":{2}, "_3":{3}, "_4":{4} , "_5":{5}}}'.format(ambientHumidity, ambientTemperature, hdc1000.readTemperature(), hdc1000.readHumidity(), adc.read_adc(2, gain=GAIN), signal)

        print data

        print 'DATA SENDING'

        data ='AT+NSOST=0,85.108.177.189,5000,{0},{1}\r'.format(str(len(data)),data.encode("hex"))
        ...
        response = ser.readline()
        response = ser.readline()
  Tags      print 'RESPONSE:%s' % response
